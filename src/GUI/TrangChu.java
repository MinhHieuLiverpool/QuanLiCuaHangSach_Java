		  ...
		  String imagePath = "src//image//lologo.jpg";
	        ...
	        label_1.addMouseListener(new MouseAdapter() {
	            ...
	            public void mouseClicked(MouseEvent e) {
	            	 ActionEvent event = new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "Quản lí sách");
	                 dispatchEvent(event);
	                System.out.println("Bạn đã nhấp chuột vào hình ảnh 1");
	            }
	        });
